...
def valid_play?(letter)
    return flase unless ALPHABET.include?(letter)
...
def take_turn
    system("clear")
    puts "It's #{current_players}'s turn!"
    letter = nil
    ...
    add_letter(letter)
    puts "#{current_player} added the letter '#{letter}' to the fragement."
end 
